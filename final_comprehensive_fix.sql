...
-- ============================================================
-- 権限とデータ表示の最終修正 (2026-03-13)
-- 1. 管理者用RPCの更新 (MANAGERロールを許可)
-- 2. 各テーブルの RLS 調整 (LIFF/anon ユーザーの読み取りを許可)
-- ============================================================
...
-- LIFFユーザー(anon)が各テーブルを読み取れるようにします
...
-- locations
DROP POLICY IF EXISTS "Allow anon read locations" ON public.locations;
CREATE POLICY "Allow anon read locations" ON public.locations 
  FOR SELECT TO anon, authenticated USING (true);
