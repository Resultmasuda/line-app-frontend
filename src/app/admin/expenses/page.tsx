        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl">
                <div className="bg-white p-6 rounded-[32px] shadow-sm border border-slate-100 flex items-center justify-between group overflow-hidden relative">
                    ...
                    <div className="w-14 h-14 rounded-2xl bg-brand-blue/10 text-brand-blue flex items-center justify-center relative z-10 shadow-inner group-hover:-rotate-6 transition-transform">
                        <Receipt size={28} strokeWidth={2.5} />
                    </div>
                </div>
                <button 
                ...
                >
                    ...
                    <div className="w-14 h-14 rounded-2xl bg-rose-50 text-rose-500 flex items-center justify-center relative z-10 shadow-inner group-hover:-rotate-6 transition-transform">
