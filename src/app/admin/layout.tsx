...
export default function AdminLayout({ children }: { children: ReactNode }) {
    return (
        <div className="flex h-screen bg-gray-50 font-sans">
            ...
            {/* モバイル用簡易ヘッダー (基本的にはPC想定だが念のため) */}
            <div className="md:hidden fixed top-0 w-full bg-white border-b border-gray-200 p-4 z-50 flex justify-between items-center">
                <span className="font-bold text-gray-800">管理画面</span>
                <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">PC推奨</span>
            </div>

            {/* メインコンテンツエリア */}
            <main className="flex-1 flex flex-col md:pt-0 pt-14 overflow-hidden">
